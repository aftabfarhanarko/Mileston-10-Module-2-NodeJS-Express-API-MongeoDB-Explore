...
import user from "../assest/image copy.png";
  ...
  return (
    <div className="max-w-md w-full h-[210px] bg-gradient-to-br from-pink-100 via-purple-100 to-indigo-100 backdrop-blur-xl border border-white/40 shadow-lg rounded-2xl p-6 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 flex flex-col justify-between">
      ...
      <div className="flex w-full items-center justify-between mt-8">
        ...
        <button className="w-full px-4 py-2 rounded-lg bg-blue-600 text-white text-sm font-semibold shadow-md hover:bg-blue-700 hover:-translate-y-[2px] transition-all duration-200 mx-2">
          Details
        </button>

        <button onClick={() => deleteHandel(items._id)} className="w-full px-4 py-2 rounded-lg border border-red-400 text-red-600 text-sm font-semibold hover:bg-red-50 hover:-translate-y-[2px] transition-all duration-200">
          Delete
        </button>
      </div>
    </div>
